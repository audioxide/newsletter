                    ...
                    <td class="container-padding content" align="left">
                        ...
                        <section>
                            ...
                            <tr>
                                <td class="col" valign="top">
                                    <img class="album-artwork"
                                         src=https://audioxide.com/api/images/album-artwork/fortitude-gojira-medium-square.jpg
                                         style="border: 3px solid #6a4e27;">
                                </td>
                            </tr>
                        </table>
                            ...
                            <table width="284" border="0" cellpadding="0" cellspacing="0" align="right" class="force-row">
                                <tr>
                                    <td class="col" valign="top">
                                        <h3 class="review-album" style="color: #6a4e27;">Fortitude</h3>
                                        <h3 class="review-artist">Gojira</h3>
                                        <p class="review-summary">‘Not everything sticks, but I suppose all the great metal albums contain at least a small portion of cheese. I would liken Fortitude to a mild cheddar. Versatile, resilient and, sometimes, unbeatable.’</p>
                                        <span class="review-link"><a href="https://audioxide.com/reviews/gojira-fortitude/">Full
                    review</a> →</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <tr>
                                <td class="col" valign="top">
                                    <img class="album-artwork"
                                         src=https://audioxide.com/api/images/album-artwork/bright-green-field-squid-medium-square.jpg
                                         style="border: 3px solid #469057;">
                                </td>
                            </tr>
                        </table>
                            ...
                            <table width="284" border="0" cellpadding="0" cellspacing="0" align="right" class="force-row">
                                <tr>
                                    <td class="col" valign="top">
                                        <h3 class="review-album" style="color: #469057;">Bright Green Field</h3>
                                        <h3 class="review-artist">Squid</h3>
                                        <p class="review-summary">‘The band take characteristics from krautrock, dub, funk, and jazz to form a sound that is remarkably coherent and wholly distinct. It’s chaotic, but it works.’</p>
                                        <span class="review-link"><a href="https://audioxide.com/reviews/squid-bright-green-field/">Full
                    review</a> →</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <tr>
                                <td class="col" valign="top">
                                    <img class="album-artwork"
                                         src=https://audioxide.com/api/images/album-artwork/daddys-home-st-vincent-medium-square.jpg
                            ...
                            <table width="284" border="0" cellpadding="0" cellspacing="0" align="right" class="force-row">
                                <tr>
                                    <td class="col" valign="top">
                                        <h3 class="review-album" style="color: #000000;">Daddy’s Home</h3>
                                        <h3 class="review-artist">St. Vincent</h3>
                                        <p class="review-summary">‘Annie Clark wrangles a myriad of vintage sounds and gives them a stunning contemporary sheen, but it is in service of a world unquestionably her own. David Bowie and Mia Wallace had a sweet baby girl and abandoned her in South Queens.’</p>
                                        <span class="review-link"><a href="https://audioxide.com/reviews/st-vincent-daddys-home/">Full
                    review</a> →</span>
                                    </td>
                                </tr>
                            </table>
